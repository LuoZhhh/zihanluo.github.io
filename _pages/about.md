...
My research interests include graph representation learning and Large Language Models (LLM), especially on topics like fairness and bias. I have published several papers at the top international AI conferences and journals with total <a href='https://scholar.google.com/citations?user=JWUJkawAAAAJ'> <strong><span id='total_cit'>10+</span></strong> google scholar citations </a> <a href='https://scholar.google.com/citations?user=JWUJkawAAAAJ'><img src="https://img.shields.io/endpoint?url={{ url | url_encode }}&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=citations"></a>.
